<template>
  <section class="place-items-center" style="z-index: 99;">
    <div class="flex justify-between px-16 my-8" style="padding: 30px 128px;">
      <div class="flex gap-4" style="margin-top: 99px;">
        <h1 class="text-4xl font-semibold" style="color: #063D63;">DEPARTEMEN</h1>
    ...
    <div class="" style="padding: 0 128px;">
      <div class="flex justify-center items-center bg-[#FFFDDB] rounded-l-3xl">
        ...
        <div class="w-full px-12 py-4 text-black">
          ...
          <div class="text-sm text-gray-500">
            Program Sarjana Teknik Sipil (Akreditasi A BAN-PT, Sertifikat AUN-QA)<br />
            Program Magister Teknik Sipil (Akreditasi A BAN-PT)<br />
            Program Doktor Ilmu Teknik Sipil (Akreditasi A BAN-PT)<br />
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-center items-center bg-[#F9E8EA] rounded-l-3xl mt-6">
        ...
        <div class="w-full px-12 py-4 text-black">
          ...
          <div class="text-sm text-gray-500">
            Program Sarjana Teknik Mesin (Akreditasi A BAN-PT)<br />
            Program Magister Teknik Mesin (Akreditasi A BAN-PT)<br />
            Program Doktor Teknik Mesin (Akreditasi B BAN-PT)<br />
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-center items-center bg-[#E7F4FC] rounded-l-3xl mt-6">
        ...
        <div class="w-full px-12 py-4 text-black">
          ...
          <div class="text-sm text-gray-500">
            Program Sarjana Teknik Perkapalan (Akreditasi A BAN-PT)<br />
            Program Magister Teknik Perkapalan (Akreditasi B BAN-PT)<br />
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-center items-center bg-[#F2FCFD] rounded-l-3xl mt-6">
        ...
        <div class="w-full px-12 py-4 text-black">
          ...
          <div class="text-sm text-gray-500">
            Program Sarjana Teknik Elektro (Akreditasi A BAN-PT)<br />
            Program Magister Teknik Elektro (Akreditasi A BAN-PT)<br />
            Program Doktor Teknik Elektro (Akreditasi B BAN-PT)<br />
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-center items-center bg-[#F8F8F8] rounded-l-3xl mt-6">
        ...
        <div class="w-full px-12 py-4 text-black">
          ...
          <div class="text-sm text-gray-500">
            Program Sarjana Teknik Arsitektur (Akreditasi A BAN-PT)<br />
            Program Magister Teknik Arsitektur (Akreditasi B BAN-PT)<br />
            Program Doktor Ilmu Arsitektur (Akreditasi A BAN-PT)<br />
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-center items-center bg-[#FEF0E2] rounded-l-3xl mt-6">
        ...
        <div class="w-full px-12 py-4 text-black">
          ...
          <div class="text-sm text-gray-500">
            Program Sarjana Teknik Geologi (Akreditasi A BAN-PT, Sertifikat AUN)<br />
            Program Magister Geologi (Akreditasi B BAN-PT)<br />
            Program Doktor Teknologi Kebumian dan Lingkungan (Akreditasi B BAN-PT)<br />
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-center items-center bg-[#F8E6E8] rounded-l-3xl mt-6">
        ...
        <div class="w-full px-12 py-4 text-black">
          ...
          <div class="text-sm text-gray-500">
            Program Sarjana Teknik Industri (Akreditasi A BAN-PT)<br />
            Program Magister Teknik Industri (Akreditasi Minimum BAN-PT)<br />
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-center items-center bg-[#E5F9FE] rounded-l-3xl mt-6">
        ...
        <div class="w-full px-12 py-4 text-black">
          ...
          <div class="text-sm text-gray-500">
            Program Sarjana Teknik Kelautan (Akreditasi A BAN-PT)<br />
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-center items-center bg-[#EEF4FA] rounded-l-3xl mt-6">
        ...
        <div class="w-full px-12 py-4 text-black">
          ...
          <div class="text-sm text-gray-500">
            Program Sarjana Teknik Sistem Perkapalan (Akreditasi A BAN-PT)<br />
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-center items-center bg-[#F3F1E6] rounded-l-3xl mt-6">
        ...
        <div class="w-full px-12 py-4 text-black">
          ...
          <div class="text-sm text-gray-500">
            Program Sarjana Perencanaan Wilayah dan Kota (Akreditasi A BAN-PT)<br />
            Program Magister Perencanaan Wilayah dan Kota (Akreditasi Minimum BAN-PT)<br />
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-center items-center bg-[#EBF3F9] rounded-l-3xl mt-6">
        ...
        <div class="w-full px-12 py-4 text-black">
          ...
          <div class="text-sm text-gray-500">
            Program Sarjana Teknik Pertambangan (Akreditasi A BAN-PT, Akreditasi Internasional ASIIN)<br />
            Program Magister Teknik Pertambangan (Akreditasi Baik BAN-PT)<br />
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-center items-center bg-[#EAF6FE] rounded-l-3xl mt-6">
        ...
        <div class="w-full px-12 py-4 text-black">
          ...
          <div class="text-sm text-gray-500">
            Program Sarjana Teknik Informatika (Akreditasi Unggul BAN-PT, Akreditasi Internasional ASIIN)<br />
            Program Magister Teknik Informatika (Akreditasi Baik BAN-PT)<br />
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-center items-center bg-[#DAEEE4] rounded-l-3xl mt-6">
        ...
        <div class="w-full px-12 py-4 text-black">
          ...
          <div class="text-sm text-gray-500">
            Program Sarjana Teknik Lingkungan (Akreditasi A BAN-PT)<br />
            Program Magister Teknik Lingkungan (Akreditasi Minimum BAN-PT)<br />
          </div>
        </div>
      </div>
    </div>
